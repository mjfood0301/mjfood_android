...
import com.lee989898.todayeat.config.Application.Companion.tokenSharedPreferences
...
class XAccessTokenInterceptor : Interceptor {
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        val jwtToken: String? = tokenSharedPreferences.getString(X_ACCESS_TOKEN, null)
        if (jwtToken != null) {
